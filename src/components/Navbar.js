      ...
      <div className="navbar">
        <div className="navbar__item">
          ...
          <div className="navbar__item__center">
            <input
              className="form-control navbar__item__center__search"
              type="search"
              placeholder="Search"
              aria-label="Search"
            />
          </div>
          <div className="navbar__item__right ">
            <ul className="navbar-icon_right">
              <li className="navbar-icon_right__item">
                <NavLink activeClassName="icon-item1" to="/home">
                  <svg
              ...
              <li className="navbar-icon_right__item">
                <NavLink activeClassName="icon-item2" to="/direct/inbox">
                  <svg
                    aria-label="Direct"
                    fill="#262626"
                    height="22"
              ...
              <li className="navbar-icon_right__item">
                <NavLink activeClassName="icon-item3" to="/explore">
                  <svg
              ...
              <li className="navbar-icon_right__item">
                <NavLink activeClassName="icon-item4" to="/notications">
                  <svg
              ...
              <li className="navbar-icon_right__item account dropdown">
                ...
                >
                  <div>
                    <a className="dropdown-item pd-se pd-bt" href="#"> Action </a>
                  </div>
                  <div>
                    <a className="dropdown-item pd-se pd-bt" href="#"> Another action </a>
                  </div>
                  <hr className="mt-1 mb-1"/>
                  <div>
                    <button className="dropdown-item pd-se pd-bt" onClick={()=>this.props.onLogOut(this.props.user.username)} >Log Out </button>
                  </div>
                </div>
              </li>
            </ul>
...
const mapDispatchToProps = (dispatch) => {
  return {
    onLogOut: (username) => dispatch({ type: actionTypes.LOGOUT, username: username }),
  };
};
